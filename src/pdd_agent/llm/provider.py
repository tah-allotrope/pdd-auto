...
_DEMO_SECTION_TEXT_BY_TECHNOLOGY = {
    ...
    "biochar_production": {
        "1.1": "This synthetic client-demo case illustrates a biochar carbon-removal project that converts biomass feedstock into stable biochar via pyrolysis, and demonstrates a Verra-style drafting workflow using deterministic demo inputs.",
        "1.10": "The synthetic demo project is modeled with feedstock dry mass, carbon fraction, and pyrolysis parameters drawn from the curated demo assumptions register. The draft carries estimated net carbon-removal credits across the defined crediting period.",
        "3.3": "The project boundary includes the pyrolysis facility and feedstock collection area. Included emission sources cover feedstock decomposition and pyrolysis energy use. Excluded emission sources are limited to upstream feedstock transport. The geographic boundary is defined by GPS coordinates of the facility and feedstock catchment. The temporal boundary covers the crediting period from start date to end date.",
        "3.4": "In this synthetic demo baseline, the biomass feedstock would otherwise decompose naturally, releasing carbon to the atmosphere. The demo assumes open decomposition as the baseline pathway and uses deterministic baseline, project, and leakage values so the narrative remains aligned with the quantification sections.",
        "3.5": "This synthetic demo presents additionality as a client-readable narrative rather than a validator-ready claim. The sample assumes the project requires dedicated pyrolysis infrastructure, feedstock supply-chain coordination, and biochar quality monitoring that would not be represented by the baseline decomposition pathway alone.",
        "4.1": "Baseline emissions in the synthetic demo are set based on the curated assumptions register. This value is carried consistently across the assumptions companion and the quantification narrative so the client-demo artifact remains internally aligned.",
        "4.2": "Project emissions in the synthetic demo are set based on the curated assumptions register, representing the modeled emissions associated with pyrolysis operation and biochar carbon storage. The value is deterministic and used consistently throughout the sample.",
        "4.4": "Net greenhouse gas emission reductions in the synthetic demo are calculated after accounting for baseline emissions, project emissions, and leakage. Across the crediting period, the synthetic sample totals are derived deterministically from annual values.",
        "5.2": "The synthetic demo monitoring plan tracks feedstock dry mass through weighbridge records and biochar carbon content through laboratory analysis. Quarterly review and digital record retention are assumed for the sample so the monitoring narrative stays coherent with the curated assumptions register.",
    },
    "improved_cookstoves": {
        "1.1": "This synthetic client-demo case illustrates an improved cookstove project that displaces traditional three-stone fires with efficient biomass stoves, reducing fuel consumption and non-renewable biomass harvesting, and demonstrates a Verra-style drafting workflow using deterministic demo inputs.",
        "1.10": "The synthetic demo project is modeled with stove fleet count, baseline and project fuel consumption rates, and non-renewable biomass fraction drawn from the curated demo assumptions register. The draft carries estimated net emission reductions across the defined crediting period.",
        "3.3": "The project boundary includes the households using distributed improved cookstoves. Included emission sources cover biomass combustion in baseline and project stoves. Excluded emission sources are limited to upstream fuel processing. The geographic boundary is defined by the enrolled household clusters. The temporal boundary covers the crediting period from start date to end date.",
        "3.4": "In this synthetic demo baseline, enrolled households would otherwise continue using traditional three-stone fires with higher fuel consumption. The demo assumes traditional stove use as the baseline practice and uses deterministic baseline, project, and leakage values so the narrative remains aligned with the quantification sections.",
        "3.5": "This synthetic demo presents additionality as a client-readable narrative rather than a validator-ready claim. The sample assumes the project requires dedicated stove manufacturing, household distribution logistics, and fuel-consumption monitoring that would not be represented by the baseline traditional-stove pathway alone.",
        "4.1": "Baseline emissions in the synthetic demo are set based on the curated assumptions register. This value is carried consistently across the assumptions companion and the quantification narrative so the client-demo artifact remains internally aligned.",
        "4.2": "Project emissions in the synthetic demo are set based on the curated assumptions register, representing the modeled emissions associated with improved cookstove adoption and reduced fuel consumption. The value is deterministic and used consistently throughout the sample.",
        "4.4": "Net greenhouse gas emission reductions in the synthetic demo are calculated after accounting for baseline emissions, project emissions, and leakage. Across the crediting period, the synthetic sample totals are derived deterministically from annual values.",
        "5.2": "The synthetic demo monitoring plan tracks stove fleet count through distribution records and fuel savings through controlled cooking tests. Annual review and digital record retention are assumed for the sample so the monitoring narrative stays coherent with the curated assumptions register.",
    },
}
